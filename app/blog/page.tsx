...
const Blog = () => {
    return (
        <section className="dark:bg-[#000435] dark:text-gray-100">
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		<Link rel="noopener noreferrer" href="/blog/1" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900">
		...
		<div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
			<Link rel="noopener noreferrer" href="/blog/2" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
			...
			<Link rel="noopener noreferrer" href="/blog/3" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
			...
			<Link rel="noopener noreferrer" href="/blog/4" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
			...
			<Link rel="noopener noreferrer" href="/blog/5" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900 hidden sm:block">
			...
			<Link rel="noopener noreferrer" href="/blog/7" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900 hidden sm:block">
			...
			<Link rel="noopener noreferrer" href="/blog/8" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900 hidden sm:block">
